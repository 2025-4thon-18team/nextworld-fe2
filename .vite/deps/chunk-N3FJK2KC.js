...
var init_Button = __esm({
  "node_modules/@locator/runtime/dist/components/Button.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$ = template(`<button class="py-1 px-1 hover:bg-white/30 pointer hover:text-gray-100 rounded">`);
...
function ClipboardButton(props) {
  ...
  return createComponent(Button, {
    ...
    get children() {
      return memo(() => !!copied())() ? (() => {
        var _el$ = _tmpl$2();
        setStyleProperty(_el$, "width", "16px");
        setStyleProperty(_el$, "height", "16px");
        return _el$;
      })() : (() => {
        var _el$2 = _tmpl$22();
        setStyleProperty(_el$2, "width", "16px");
        setStyleProperty(_el$2, "height", "16px");
        return _el$2;
      })();
    }
  });
}
var _tmpl$2, _tmpl$22;
var init_ClipboardButton = __esm({
  "node_modules/@locator/runtime/dist/components/ClipboardButton.js"() {
    ...
    init_dev();
    init_Button();
    _tmpl$2 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"style=pointer-events:none><title>check-bold</title><path fill=green d=M9,20.42L2.79,14.21L5.62,11.38L9,14.77L18.88,4.88L21.71,7.71L9,20.42Z>`);
    _tmpl$22 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"style=pointer-events:none><path fill=currentColor d="M19,21H8V7H19M19,5H8A2,2 0 0,0 6,7V21A2,2 0 0,0 8,23H19A2,2 0 0,0 21,21V7A2,2 0 0,0 19,5M16,1H4A2,2 0 0,0 2,3V17H4V3H16V1Z">`);
  }
});
...
function ComponentOutline(props) {
  ...
  return (() => {
    ...
    setStyleProperty(_el$, "position", "fixed");
      ...
      children: (label2) => {
        ...
        return link ? (() => {
          ...
          createRenderEffect((_p$) => {
            var _v$1 = labelStyles, _v$10 = options.getOptions().hrefTarget || HREF_TARGET;
            _p$.e = style(_el$4, _v$1, _p$.e);
            _v$10 !== _p$.t && setAttribute(_el$4, "target", _p$.t = _v$10);
            return _p$;
          }, {
            e: void 0,
            t: void 0
          ...
          createRenderEffect((_$p) => style(_el$5, labelStyles, _$p));
          return _el$5;
        })();
      }
    }));
    createRenderEffect((_p$) => {
      var _v$ = left() + "px", _v$2 = top() + "px", _v$3 = width() + "px", _v$4 = height() + "px", _v$5 = left() === 0 || top() === 0 ? "0" : "8px", _v$6 = left() + width() === window.innerWidth || top() === 0 ? "0" : "8px", _v$7 = left() === 0 || top() + height() === window.innerHeight ? "0" : "8px", _v$8 = left() + width() === window.innerWidth || top() + height() === window.innerHeight ? "0" : "8px", _v$9 = {
        position: "absolute",
        display: "flex",
      ...
      _v$5 !== _p$.i && setStyleProperty(_el$, "border-top-left-radius", _p$.i = _v$5);
      _v$6 !== _p$.n && setStyleProperty(_el$, "border-top-right-radius", _p$.n = _v$6);
      _v$7 !== _p$.s && setStyleProperty(_el$, "border-bottom-left-radius", _p$.s = _v$7);
      _v$8 !== _p$.h && setStyleProperty(_el$, "border-bottom-right-radius", _p$.h = _v$8);
      _p$.r = style(_el$2, _v$9, _p$.r);
      _v$0 !== _p$.d && setStyleProperty(_el$3, "padding", _p$.d = _v$0);
      return _p$;
    }, {
      e: void 0,
      t: void 0,
...
var init_ComponentOutline = __esm({
  "node_modules/@locator/runtime/dist/components/ComponentOutline.js"() {
    ...
    init_buildLink();
    init_optionsStore();
    _tmpl$3 = template(`<div class="border border-purple-500"style=z-index:1><div id=locatorjs-labels-section style=justify-content:center;pointer-events:auto><div id=locatorjs-labels-wrapper>`);
    _tmpl$23 = template(`<a class="cursor-pointer bg-purple-500 block text-white text-xs font-bold text-center px-1 py-0.5 rounded whitespace-nowrap pointer-events-auto hover:bg-purple-600">`);
    _tmpl$32 = template(`<div class="cursor-pointer bg-purple-500 block text-white text-xs font-bold text-center px-1 py-0.5 rounded whitespace-nowrap pointer-events-auto hover:bg-purple-600">`);
    delegateEvents(["click"]);
  }
});
...
function RenderBoxes(props) {
  return [memo(() => Object.entries(props.allBoxes.margin).map(([, box]) => {
    return (() => {
      var _el$2 = _tmpl$24();
      createRenderEffect((_p$) => {
        var _v$5 = box.left + "px", _v$6 = box.top + "px", _v$7 = box.width + "px", _v$8 = box.height + "px";
        _v$5 !== _p$.e && setStyleProperty(_el$2, "left", _p$.e = _v$5);
        _v$6 !== _p$.t && setStyleProperty(_el$2, "top", _p$.t = _v$6);
    ...
    return (() => {
      var _el$3 = _tmpl$33();
      createRenderEffect((_p$) => {
        var _v$9 = box.left + "px", _v$0 = box.top + "px", _v$1 = box.width + "px", _v$10 = box.height + "px";
        _v$9 !== _p$.e && setStyleProperty(_el$3, "left", _p$.e = _v$9);
        _v$0 !== _p$.t && setStyleProperty(_el$3, "top", _p$.t = _v$0);
        _v$1 !== _p$.a && setStyleProperty(_el$3, "width", _p$.a = _v$1);
        _v$10 !== _p$.o && setStyleProperty(_el$3, "height", _p$.o = _v$10);
        return _p$;
      }, {
        e: void 0,
        t: void 0,
    ...
    createRenderEffect((_p$) => {
      var _v$ = props.allBoxes.innerBox.left + "px", _v$2 = props.allBoxes.innerBox.top + "px", _v$3 = props.allBoxes.innerBox.width + "px", _v$4 = props.allBoxes.innerBox.height + "px";
      _v$ !== _p$.e && setStyleProperty(_el$, "left", _p$.e = _v$);
      _v$2 !== _p$.t && setStyleProperty(_el$, "top", _p$.t = _v$2);
      _v$3 !== _p$.a && setStyleProperty(_el$, "width", _p$.a = _v$3);
      _v$4 !== _p$.o && setStyleProperty(_el$, "height", _p$.o = _v$4);
...
var init_RenderBoxes = __esm({
  "node_modules/@locator/runtime/dist/components/RenderBoxes.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$4 = template(`<div class="fixed flex text-xs font-bold items-center justify-center text-blue-500 bg-blue-500/30"style="text-shadow:-1px 1px 0 #fff, 1px 1px 0 #fff, 1px -1px 0 #fff, -1px -1px 0 #fff">`);
    _tmpl$24 = template(`<div class="fixed flex text-xs font-bold items-center justify-center text-orange-500 bg-orange-500/30"style="text-shadow:-1px 1px 0 #fff, 1px 1px 0 #fff, 1px -1px 0 #fff, -1px -1px 0 #fff">`);
    _tmpl$33 = template(`<div class="fixed flex text-xs font-bold items-center justify-center text-green-500 bg-green-500/30"style="text-shadow:-1px 1px 0 #fff, 1px 1px 0 #fff, 1px -1px 0 #fff, -1px -1px 0 #fff">`);
  }
});
...
var init_Tooltip = __esm({
  "node_modules/@locator/runtime/dist/components/Tooltip.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$5 = template(`<div class="group/tooltip relative block"><div role=tooltip>`);
  }
});
...
function Outline(props) {
  ...
  const parentsWithLinks = () => getParentsPaths5(props.element.htmlElement).filter((parent) => parent.link);
  return [(() => {
    var _el$ = _tmpl$25(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild;
    insert(_el$, (() => {
      var _c$ = memo(() => !!domElementInfo());
    ...
    insert(_el$3, createComponent(Tooltip, {
      ...
      get children() {
        return createComponent(Button, {
          ...
          get children() {
            var _el$4 = _tmpl$6();
            setStyleProperty(_el$4, "width", "16px");
            setStyleProperty(_el$4, "height", "16px");
            return _el$4;
          }
        });
      }
    ...
    insert(_el$3, (() => {
      var _c$2 = memo(() => parentsWithLinks().length > 1);
      return () => _c$2() && createComponent(Tooltip, {
        tooltipText: "Parents",
        get children() {
          return createComponent(Button, {
            onClick: () => {
            ...
            get children() {
              var _el$5 = _tmpl$34();
              setStyleProperty(_el$5, "width", "16px");
              setStyleProperty(_el$5, "height", "16px");
              return _el$5;
            }
          });
        }
    ...
    createRenderEffect((_p$) => {
      var _v$ = box().x + "px", _v$2 = box().y + "px", _v$3 = box().width + "px", _v$4 = box().height + "px", _v$5 = {
        ...getOffset()
      };
    ...
    return _el$;
  })(), memo(() => memo(() => props.element.componentsLabels.length > 0)() && createComponent(ComponentOutline, {
    get labels() {
...
var init_Outline = __esm({
  "node_modules/@locator/runtime/dist/components/Outline.js"() {
    ...
    init_RenderBoxes();
    init_Tooltip();
    _tmpl$6 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"style=pointer-events:none><title>sitemap</title><path fill=currentColor d="M9,2V8H11V11H5C3.89,11 3,11.89 3,13V16H1V22H7V16H5V13H11V16H9V22H15V16H13V13H19V16H17V22H23V16H21V13C21,11.89 20.11,11 19,11H13V8H15V2H9Z">`);
    _tmpl$25 = template(`<div><div class="fixed flex text-xs font-bold items-center justify-center text-sky-500 rounded border border-solid border-sky-500"style="z-index:2;text-shadow:-1px 1px 0 #fff, 1px 1px 0 #fff, 1px -1px 0 #fff, -1px -1px 0 #fff;text-overflow:ellipsis"><div class="absolute bg-black/60 text-white font-bold rounded-md px-1 py-1 flex"style=text-shadow:none;pointer-events:auto>`);
    _tmpl$34 = template(`<svg xmlns=http://www.w3.org/2000/svg viewBox="0 0 24 24"style=pointer-events:none><title>format-list-text</title><path fill=currentColor d="M2 14H8V20H2M16 8H10V10H16M2 10H8V4H2M10 4V6H22V4M10 20H16V18H10M10 16H22V14H10">`);
  }
});
...
function MaybeOutline(props) {
  ...
  return memo(() => memo(() => !!elInfo())() ? createComponent(Outline, {
    get element() {
      return elInfo();
    },
    get showTreeFromElement() {
    ...
    setStyleProperty(_el$2, "position", "absolute");
    setStyleProperty(_el$2, "border", "1px solid rgba(222, 0, 0, 0.5)");
    createRenderEffect((_p$) => {
      var _v$ = box().x + "px", _v$2 = box().y + "px", _v$3 = box().width + "px", _v$4 = box().height + "px";
      _v$ !== _p$.e && setStyleProperty(_el$2, "left", _p$.e = _v$);
      _v$2 !== _p$.t && setStyleProperty(_el$2, "top", _p$.t = _v$2);
      _v$3 !== _p$.a && setStyleProperty(_el$2, "width", _p$.a = _v$3);
      _v$4 !== _p$.o && setStyleProperty(_el$2, "height", _p$.o = _v$4);
...
function SimpleNodeOutline(props) {
  ...
  return (() => {
    ...
    insert(_el$, (() => {
      ...
      return () => _c$() ? (() => {
        var _el$2 = _tmpl$8();
        setStyleProperty(_el$2, "position", "fixed");
        createRenderEffect((_p$) => {
          var _v$ = box().x - offset3() + "px", _v$2 = box().y - offset3() + "px", _v$3 = box().width + offset3() * 2 + "px", _v$4 = box().height + offset3() * 2 + "px", _v$5 = props.node.type === "component" ? "2px solid rgba(200,0,0,1)" : "1px solid rgba(200,0,0,1)", _v$6 = props.node.type === "component" ? "5px" : "3px", _v$7 = props.node.type === "component" ? 1e3 : 10;
          _v$ !== _p$.e && setStyleProperty(_el$2, "left", _p$.e = _v$);
          _v$2 !== _p$.t && setStyleProperty(_el$2, "top", _p$.t = _v$2);
          _v$3 !== _p$.a && setStyleProperty(_el$2, "width", _p$.a = _v$3);
          _v$4 !== _p$.o && setStyleProperty(_el$2, "height", _p$.o = _v$4);
          _v$5 !== _p$.i && setStyleProperty(_el$2, "border", _p$.i = _v$5);
          _v$6 !== _p$.n && setStyleProperty(_el$2, "border-radius", _p$.n = _v$6);
          _v$7 !== _p$.s && setStyleProperty(_el$2, "z-index", _p$.s = _v$7);
          return _p$;
        }, {
          e: void 0,
          t: void 0,
...
function LogoIcon(_props) {
  ...
  return (() => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = props.width + "px", _v$2 = props.width / 276 * 66 + "px";
...
var init_OpenSettingsButton = __esm({
  "node_modules/@locator/runtime/dist/components/OpenSettingsButton.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$10 = template(`<button class="bg-slate-100 py-1 px-2 rounded hover:bg-slate-300 active:bg-slate-200 cursor-pointer text-xs">`);
  }
});
...
var init_BannerHeader = __esm({
  "node_modules/@locator/runtime/dist/components/BannerHeader.js"() {
    ...
    _tmpl$11 = template(`<div class="flex justify-between gap-2">`);
  }
});
...
function IntroInfo(props) {
  ...
  const modifiers = () => getMouseModifiers();
  return (() => {
    var _el$ = _tmpl$12(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$6 = _el$3.nextSibling, _el$5 = _el$6.nextSibling, _el$7 = _el$2.nextSibling, _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling;
    ...
    insert(_el$2, createComponent(For, {
      ...
      children: (key, i) => {
        return [memo(() => i() === 0 ? "" : " + "), (() => {
          var _el$0 = _tmpl$26();
          insert(_el$0, () => modifiersTitles[key]);
          return _el$0;
        })()];
      }
    }), _el$6);
    ...
    createRenderEffect((_p$) => {
      var _v$ = bannerClasses(), _v$2 = showIntro() ? "12px" : "-120px";
      _v$ !== _p$.e && className(_el$, _p$.e = _v$);
      _v$2 !== _p$.t && setStyleProperty(_el$, "bottom", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
var init_IntroInfo = __esm({
  "node_modules/@locator/runtime/dist/components/IntroInfo.js"() {
    ...
    _tmpl$26 = template(`<div class="inline-block px-1 py-0.5 border border-slate-200 rounded">`);
    delegateEvents(["click"]);
  }
});
...
function OptionsCloseButton(props) {
  return (() => {
    ...
    setStyleProperty(_el$2, "width", "20px");
    setStyleProperty(_el$2, "height", "20px");
    return _el$;
  })();
}
var _tmpl$13;
var init_OptionsCloseButton = __esm({
  "node_modules/@locator/runtime/dist/components/OptionsCloseButton.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$13 = template(`<button class="w-6 h-6 rounded hover:bg-slate-100 flex items-center justify-center text-slate-400 hover:text-slate-600"><svg viewBox="0 0 24 24"><path fill=currentColor d=M13.46,12L19,17.54V19H17.54L12,13.46L6.46,19H5V17.54L10.54,12L5,6.46V5H6.46L12,10.54L17.54,5H19V6.46L13.46,12Z>`);
    delegateEvents(["click"]);
  }
});
...
function EditorLinkForm(props) {
  ...
  return (() => {
    var _el$ = _tmpl$14(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$2.nextSibling;
    _el$4.$$click = () => {
    ...
    insert(_el$, (() => {
      var _c$ = memo(() => props.selectedTarget !== void 0);
      return () => _c$() ? [(() => {
        var _el$6 = _tmpl$27(), _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild;
        insert(_el$6, createComponent(For, {
          get each() {
            return Object.entries(props.targets);
          },
          children: ([key, target]) => (() => {
            var _el$9 = _tmpl$35(), _el$0 = _el$9.firstChild, _el$1 = _el$0.nextSibling;
            _el$0.$$click = () => {
              props.selectTarget(key);
            };
            setAttribute(_el$0, "id", key);
            setAttribute(_el$1, "for", key);
            insert(_el$1, () => target.label);
            createRenderEffect(() => _el$0.checked = key === selectedTarget());
            return _el$9;
          })()
        }), _el$7);
        _el$8.$$click = () => {
        ...
        createRenderEffect(() => className(_el$11, "shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-slate-300 rounded-md " + (props.targets[selectedTarget()] ? "text-slate-400" : "text-slate-800")));
        createRenderEffect(() => _el$11.value = props.targets[selectedTarget()] ? props.targets[selectedTarget()]?.url : selectedTarget());
        return _el$10;
      })())] : null;
    })(), null);
    return _el$;
...
var _tmpl$14, _tmpl$27, _tmpl$35, _tmpl$42;
var init_EditorLinkForm = __esm({
  "node_modules/@locator/runtime/dist/components/EditorLinkForm.js"() {
    ...
    _tmpl$27 = template(`<div class="flex flex-col gap-1 py-1"><div class="flex items-center"><input id=custom type=radio class="focus:ring-indigo-200 h-4 w-4 text-indigo-600 border-slate-300 hover:border-slate-400"><label for=custom class="ml-2 block text-sm font-medium text-slate-700 hover:text-slate-800">Custom`);
    _tmpl$35 = template(`<div class="flex items-center"><input type=radio class="focus:ring-indigo-200 h-4 w-4 text-indigo-600 border-slate-300 hover:border-slate-400"><label class="ml-2 block text-sm font-medium text-slate-700 hover:text-slate-800">`);
...
function ProjectLinkForm(props) {
  return (() => {
    var _el$ = _tmpl$15(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$2.nextSibling;
    _el$4.$$click = () => {
    ...
    insert(_el$, (() => {
      var _c$ = memo(() => props.value !== void 0);
      return () => _c$() ? (() => {
...
function TransformLinkForm(props) {
  ...
  return (() => {
    var _el$ = _tmpl$16(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$2.nextSibling;
    _el$4.$$click = () => {
      if (props.value === void 0) {
    ...
    insert(_el$, (() => {
      var _c$ = memo(() => props.value !== void 0);
      return () => _c$() ? (() => {
        var _el$6 = _tmpl$29(), _el$7 = _el$6.firstChild, _el$8 = _el$7.firstChild, _el$9 = _el$8.firstChild, _el$0 = _el$9.nextSibling, _el$1 = _el$8.nextSibling, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling;
        _el$0.$$input = (e) => {
          props.onChange({
        ...
        insert(_el$6, (() => {
          var _c$2 = memo(() => !!isInvalid());
          return () => _c$2() ? _tmpl$36() : null;
        })(), null);
        createRenderEffect(() => _el$0.value = props.value.from);
        createRenderEffect(() => _el$11.value = props.value.to);
        return _el$6;
      })() : null;
    })(), null);
    return _el$;
...
var _tmpl$16, _tmpl$29, _tmpl$36, defaultValue;
...
function LinkHrefTarget(props) {
  ...
  return (() => {
    var _el$ = _tmpl$17(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling;
    _el$4.$$click = () => {
      if (props.value === void 0) {
    ...
    insert(_el$, (() => {
      ...
      return () => _c$() ? [_tmpl$210(), (() => {
        ...
        insert(_el$6, createComponent(For, {
          ...
          children: ([key, target]) => (() => {
            var _el$7 = _tmpl$43(), _el$8 = _el$7.firstChild, _el$9 = _el$8.nextSibling;
            _el$8.$$click = () => {
              props.onChange(key);
            };
...
var _tmpl$17, _tmpl$210, _tmpl$37, _tmpl$43, hrefTargets;
var init_LinkHrefTarget = __esm({
  "node_modules/@locator/runtime/dist/components/LinkHrefTarget.js"() {
    ...
    init_dev();
    init_consts();
    _tmpl$17 = template(`<div class="mt-2 border border-gray-200 rounded p-4 flex flex-col gap-1"><div class="flex justify-between self-stretch text-sm"><div>Link Href Target</div><a class="underline cursor-pointer">`);
    _tmpl$210 = template(`<div class="text-xs text-gray-700">Hot-reloading On some stacks (e.g. Create React App) gets broken when you use _blank as the target. You can change the target to _self to fix this. <br>Some browsers open unnecessary tabs when you use _blank.`);
    _tmpl$37 = template(`<div class="flex flex-col gap-1 py-1">`);
...
function LinkOptions(props) {
  ...
  return (() => {
    var _el$ = _tmpl$18(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.firstChild;
    ...
    insert(_el$3, (() => {
      var _c$ = memo(() => !!currentLink());
      return () => _c$() ? (() => {
        var _el$5 = _tmpl$211();
        insert(_el$5, currentLink);
        createRenderEffect((_p$) => {
          var _v$ = currentLink(), _v$2 = options.getOptions().hrefTarget || HREF_TARGET;
          _v$ !== _p$.e && setAttribute(_el$5, "href", _p$.e = _v$);
          _v$2 !== _p$.t && setAttribute(_el$5, "target", _p$.t = _v$2);
          return _p$;
        }, {
          e: void 0,
          t: void 0
...
var init_LinkOptions = __esm({
  "node_modules/@locator/runtime/dist/components/LinkOptions.js"() {
    ...
    init_consts();
    init_LinkHrefTarget();
    _tmpl$18 = template(`<div><div class=mt-4><div class="text-sm flex flex-col bg-green-50 text-green-800 p-4 -mx-4 rounded whitespace-pre-wrap break-all"><label for=email class="block text-xs text-green-700">Link preview:`);
    _tmpl$211 = template(`<a class=hover:underline>`);
  }
});
...
function Options(props) {
  ...
  return (() => {
    var _el$ = _tmpl$19(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$4 = _el$3.nextSibling, _el$5 = _el$4.firstChild, _el$6 = _el$5.nextSibling, _el$7 = _el$6.firstChild;
    ...
    setStyleProperty(_el$7, "width", "16px");
    setStyleProperty(_el$7, "height", "16px");
...
var init_LinkThatWorksWithOption = __esm({
  "node_modules/@locator/runtime/dist/components/LinkThatWorksWithOption.js"() {
    ...
    init_dev2();
    init_dev2();
    _tmpl$20 = template(`<a target=_blank class=underline>`);
    delegateEvents(["click"]);
  }
});
...
function NoLinkDialog() {
  return (() => {
    var _el$ = _tmpl$21(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$9 = _el$5.nextSibling, _el$0 = _el$9.nextSibling, _el$1 = _el$0.firstChild, _el$10 = _el$1.firstChild, _el$11 = _el$10.nextSibling, _el$12 = _el$11.nextSibling;
    ...
    insert(_el$10, createComponent(LinkThatWorksWithOption, {
      href: "https://www.locatorjs.com/install/react-data-id",
      children: "React"
    }));
    insert(_el$11, createComponent(LinkThatWorksWithOption, {
...
function WelcomeScreen(props) {
  ...
  return (() => {
    var _el$ = _tmpl$30(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.firstChild, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild, _el$7 = _el$6.nextSibling;
    ...
    createRenderEffect((_p$) => {
      var _v$ = currentLink(), _v$2 = options.getOptions().hrefTarget || HREF_TARGET;
      _v$ !== _p$.e && setAttribute(_el$6, "href", _p$.e = _v$);
      _v$2 !== _p$.t && setAttribute(_el$6, "target", _p$.t = _v$2);
      return _p$;
    }, {
      e: void 0,
      t: void 0
...
function TreeNodeElementView(props) {
  ...
  return (() => {
    var _el$3 = _tmpl$38(), _el$4 = _el$3.firstChild, _el$5 = _el$4.firstChild, _el$6 = _el$5.firstChild, _el$7 = _el$6.firstChild, _el$9 = _el$7.nextSibling, _el$8 = _el$9.nextSibling, _el$0 = _el$6.nextSibling, _el$1 = _el$5.nextSibling;
    ...
    insert(_el$3, (() => {
      var _c$ = memo(() => !!showComponentWrapper());
      return () => _c$() && (() => {
        var _el$10 = _tmpl$44(), _el$11 = _el$10.firstChild;
        insert(_el$10, componentLink, _el$11);
        insert(_el$11, () => cropPath(props.node.getComponent()?.definitionLink?.fileName || ""));
        return _el$10;
      })();
    })(), _el$4);
    _el$5.$$click = () => {
    ...
    insert(_el$6, (() => {
      var _c$2 = memo(() => !!preferInlineComponent());
      return () => _c$2() && componentLink();
    })(), null);
    insert(_el$0, (() => {
      var _c$3 = memo(() => !!(isDifferentFilePath() && !showComponentWrapper()));
      return () => _c$3() ? cropPath(props.node.getSource()?.fileName || "") : null;
    })());
    insert(_el$1, (() => {
      var _c$4 = memo(() => !!props.expandedIds.has(props.node.uniqueId));
      return () => _c$4() ? renderChildren() : memo(() => !!props.node.getChildren().length)() ? (() => {
        var _el$12 = _tmpl$52();
        _el$12.$$click = () => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = "text-xs pl-2 " + (props.highlightedId === props.node.uniqueId ? "bg-yellow-100 " : " ") + (showBorder() ? "border border-gray-300 py-2 pr-2 " : " ") + (props.node.getSource() ? "text-black " : "text-gray-500 "), _v$2 = showComponentWrapper() ? "pl-2" : "", _v$3 = "flex justify-between items-center gap-4 " + (props.node.getSource() ? " cursor-pointer hover:bg-sky-100" : "");
...
var _tmpl$31, _tmpl$212, _tmpl$38, _tmpl$44, _tmpl$52;
var init_TreeNodeElementView = __esm({
  "node_modules/@locator/runtime/dist/components/TreeNodeElementView.js"() {
    ...
    init_goTo();
    init_optionsStore();
    _tmpl$31 = template(`<div class="font-bold cursor-pointer text-black hover:bg-gray-100 rounded">`);
    _tmpl$212 = template(`<div class=font-bold>`);
    _tmpl$38 = template(`<div><div><div><div class="font-mono flex gap-1">&lt;<!>></div><div class="whitespace-nowrap text-ellipsis overflow-hidden"></div></div><div>`);
...
var noOffsets, SCROLLBAR_MAX, absoluteOrFixed, getElementRects, platform, offset2, shift2, flip2, computePosition2;
...
function TreeView(props) {
  ...
  return (() => {
    var _el$ = _tmpl$39(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild;
    _el$.$$click = (e) => {
    ...
    setStyleProperty(_el$, "position", "fixed");
    setStyleProperty(_el$, "top", "0");
    setStyleProperty(_el$, "left", "0");
    setStyleProperty(_el$, "width", "100vw");
    setStyleProperty(_el$, "height", "100vh");
    var _ref$ = contentRef;
    typeof _ref$ === "function" ? use(_ref$, _el$2) : contentRef = _el$2;
    setStyleProperty(_el$2, "position", "absolute");
    insert(_el$3, (() => {
      var _c$ = memo(() => !!props.treeState);
      return () => _c$() ? (() => {
        var _el$4 = _tmpl$213();
        insert(_el$4, (() => {
          var _c$2 = memo(() => !!props.treeState?.root.getParent());
          return () => _c$2() ? (() => {
            var _el$5 = _tmpl$310(), _el$6 = _el$5.firstChild;
            _el$6.$$click = () => {
    ...
    createRenderEffect((_p$) => {
      var _v$ = `${pos()?.y || 0}px`, _v$2 = `${pos()?.x || 0}px`;
...
var _tmpl$39, _tmpl$213, _tmpl$310;
var init_TreeView = __esm({
  "node_modules/@locator/runtime/dist/components/TreeView.js"() {
    ...
    _tmpl$39 = template(`<div style=pointer-events:auto;background-color:rgba(0,0,0,0.1);z-index:1001><div><div class="m-2 bg-white rounded-md p-4 shadow-xl text-xs overflow-auto"style="max-height:calc(100vh - 16px)">`);
    _tmpl$213 = template(`<div>`);
...
function DisableConfirmation(props) {
  const options = useOptions();
  return (() => {
    var _el$ = _tmpl$40(), _el$2 = _el$.firstChild, _el$3 = _el$2.nextSibling, _el$4 = _el$3.nextSibling, _el$5 = _el$4.nextSibling, _el$6 = _el$5.firstChild;
    insert(_el$2, createComponent(LogoIcon, {}), null);
    insert(_el$2, createComponent(OptionsCloseButton, {
      onClick: () => props.onClose()
    }), null);
    addEventListener2(_el$6, "click", () => {
      options.setOptions({
        disabled: true
      });
    });
  ...
  return (() => {
    ...
    insert(_el$3, createComponent(For, {
      ...
      children: (path, index) => {
        ...
        return (() => {
          var _el$4 = _tmpl$214(), _el$5 = _el$4.firstChild;
          _el$4.$$click = (e) => {
            e.preventDefault();
            e.stopPropagation();
          ...
          insert(_el$5, () => getUsableFileName(link.filePath || ""));
          createRenderEffect((_p$) => {
            var _v$3 = "px-4 py-2 w-60 hover:bg-slate-50 text-left text-sm font-medium " + (index() === focusedIndex() ? "bg-slate-100" : ""), _v$4 = buildLink(link, props.targets, options);
            _v$3 !== _p$.e && className(_el$4, _p$.e = _v$3);
            _v$4 !== _p$.t && setAttribute(_el$4, "href", _p$.t = _v$4);
            return _p$;
          }, {
            e: void 0,
            t: void 0
    ...
    createRenderEffect((_p$) => {
      var _v$ = `${props.contextMenuState.y || 0}px`, _v$2 = `${props.contextMenuState.x || 0}px`;
      _v$ !== _p$.e && setStyleProperty(_el$2, "top", _p$.e = _v$);
      _v$2 !== _p$.t && setStyleProperty(_el$2, "left", _p$.t = _v$2);
      return _p$;
    }, {
...
var init_ContextView = __esm({
  "node_modules/@locator/runtime/dist/components/ContextView.js"() {
    ...
    init_goTo();
    init_optionsStore();
    _tmpl$41 = template(`<div tabindex=0 style=pointer-events:auto;background-color:rgba(0,0,0,0.1);z-index:1001><div><div class="bg-white rounded-md py-2 shadow-xl text-xs overflow-auto flex flex-col"style="max-height:calc(100vh - 16px)">`);
    _tmpl$214 = template(`<a><div class="text-xs text-gray-500">`);
...
function Runtime(props) {
  ...
  return [memo(() => memo(() => uiMode()[0] === "tree")() ? createComponent(TreeView, {
    get treeState() {
      return uiMode()[1];
    },
    close: () => setUiMode(["off"]),
    ...
    setHighlightedNode
  }) : null), memo(() => memo(() => uiMode()[0] === "context")() ? createComponent(ContextView, {
    ...
    setHighlightedNode
  }) : null), memo(() => memo(() => !!((holdingModKey() || uiMode()[0] === "options") && currentElement()))() ? createComponent(MaybeOutline, {
    get currentElement() {
    ...
    copyToClipboard
  }) : null), memo(() => memo(() => !!holdingModKey())() ? (() => {
    var _el$ = _tmpl$45(), _el$2 = _el$.firstChild, _el$3 = _el$2.firstChild, _el$5 = _el$3.nextSibling;
    insert(_el$, createComponent(BannerHeader, {
      openOptions,
      get adapter() {
        return props.adapterId;
    ...
    return _el$;
  })() : null), memo(() => memo(() => !!highlightedNode())() ? createComponent(SimpleNodeOutline, {
    get node() {
      return highlightedNode();
    }
  }) : null), memo(() => memo(() => !!(!isExtension() && options.getOptions().showIntro !== false))() ? createComponent(IntroInfo, {
    openOptions,
    get hide() {
  ...
  }) : null), memo(() => memo(() => uiMode()[0] === "options")() ? createComponent(Options, {
    get adapterId() {
      return props.adapterId;
    },
    get targets() {
  ...
  }) : null), memo(() => memo(() => uiMode()[0] === "disable-confirmation")() ? createComponent(DisableConfirmation, {
    onClose: () => {
      setUiMode(["off"]);
    }
  }) : null), memo(() => memo(() => !!dialog())() && (() => {
    var _el$6 = _tmpl$215();
    _el$6.$$click = (e) => {
      if (e.currentTarget === e.target) {
        setDialog(null);
    ...
    insert(_el$6, (() => {
      var _c$ = memo(() => dialog()[0] === "no-link");
      return () => _c$() && createComponent(NoLinkDialog, {});
    })(), null);
    insert(_el$6, (() => {
      var _c$2 = memo(() => dialog()[0] === "choose-editor");
      return () => _c$2() && createComponent(WelcomeScreen, {
        get targets() {
          return props.targets;
        },
...
var init_Runtime = __esm({
  "node_modules/@locator/runtime/dist/components/Runtime.js"() {
    ...
    init_ContextView();
    _tmpl$45 = template(`<div><div class="mt-2 text-xs text-gray-600">Support me on <a class="underline hover:text-sky-900 text-sky-700"href=https://github.com/sponsors/infi-pc target=_blank>GitHub sponsors`);
    _tmpl$215 = template(`<div class="fixed top-0 left-0 w-screen h-screen flex items-center justify-center bg-black/70 pointer-events-auto">`);
    delegateEvents(["click"]);
  }
});
...
//# sourceMappingURL=chunk-N3FJK2KC.js.map
